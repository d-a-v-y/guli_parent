...
@CrossOrigin
@Controller   //这里不使用RestController
...
public class WxApiController {
    ...
    public String callback(String code, String state) {
        try {
            ...
            //2、拿着code请求微信固定的地址，分别得到两个值 access_token 和 openid
            ...
            if (member == null) { //若member为空，说明表中没有相同微信数据进行添加
    ...
    public String getWxCode() {
        ...
        /*String url = "https://open.weixin.qq.com/connect/qrconnect?appid="+
                ConstantWxUtils.WX_OPEN_APP_ID+"&response_type=code";*/
